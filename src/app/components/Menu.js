  ...
  return (
    <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white p-4">
      ...
      <div className="grid grid-cols-4 gap-4 mt-4 text-center">
        <button className="bg-gray-700 hover:bg-gray-600 p-3 rounded-lg">📖 Collection</button>
        <button className="bg-gray-700 hover:bg-gray-600 p-3 rounded-lg">🎴 Boosters</button>
        <button className="bg-gray-700 hover:bg-gray-600 p-3 rounded-lg">💲 Marché</button>
